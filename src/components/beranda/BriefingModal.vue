        ...
        <div class="relative w-full max-w-lg dark:bg-zinc-900 bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div class="px-5 pb-5 flex gap-2">
            ...
            <button @click="handleToggleTTS" :disabled="ttsLoading"
              ...
              <i v-else :class="isSpeaking && speakingStep === 'briefing' ? 'ri-stop-fill' : 'ri-volume-up-line'" />
              {{ ttsLoading ? 'Memuat suara...' : isSpeaking && speakingStep === 'briefing' ? 'Hentikan Suara' :
                'Dengarkan Briefing' }}
            </button>
