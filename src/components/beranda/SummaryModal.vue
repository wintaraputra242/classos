        ...
        <div class="relative w-full max-w-lg dark:bg-zinc-900 bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div class="flex items-center justify-between px-5 py-4 border-b dark:border-zinc-700 border-gray-100">
            <div class="flex items-center gap-2">
              ...
              <h3 class="font-bold dark:text-white text-gray-900 text-sm">Summary</h3>
              <span class="text-[10px] dark:text-gray-500 text-gray-400">Langkah 3 dari 4</span>
            </div>
          ...
          <div class="p-5">
            ...
            <div v-if="loading && !summaryText" class="py-2">
              <div class="flex items-center gap-2 mb-4">
                ...
                <span class="text-xs font-medium dark:text-gray-400 text-gray-500">Menyusun summary...</span>
              </div>
            ...
            <!-- Error state -->
            <div v-else-if="error && !summaryText" class="py-6 flex flex-col items-center text-center gap-2">
              <i class="ri-error-warning-line text-2xl text-red-500" />
              <p class="text-xs dark:text-gray-400 text-gray-500">Gagal memuat summary. Silakan coba lagi.</p>
